...
class User_Admin_Setup {
    ...
    public function __construct() {
        ...
        // Ha szükséges, itt regisztráld a beállításokat is az admin_init hook-on
    ...
    public function register_settings() {
        // Itt regisztrálhatod az opciókat, melyeket a formulumok mentésénél használsz
        // Például:
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Írd be azt az URL-t (vagy slug-ot), ahol a regisztrációs oldal megjelenik.', 'ebook-sales' ); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Írd be azt az URL-t (vagy slug-ot), ahol a login oldal elérhető lesz.', 'ebook-sales' ); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Írd be azt az URL-t (vagy slug-ot), ahol a user oldal elérhető lesz.', 'ebook-sales' ); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php _e( 'Adj meg további konfigurációs beállításokat a felhasználóknak.', 'ebook-sales' ); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
